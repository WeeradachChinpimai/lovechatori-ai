...
{{-- Lucide icons (https://lucide.dev) inlined as SVG so they survive Livewire
     wire:navigate SPA transitions (no JS re-init needed). Strokes inherit
     currentColor; size & color come from utility classes on the element. --}}
@php
    $paths = match ($name) {
